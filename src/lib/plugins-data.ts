    ...
    permissions: [
      {
        ...
        description: 'สิทธิ์ใช้งานประตู Crying Obsidian และคำสั่งแนะนำตัวเบื้องต้น (รองรับ voidscape.enter)',
        default: 'true',
      },
      {
        node: 'evergarden.admin',
        description: 'สิทธิ์ผู้ดูแลระบบสำหรับคำสั่งวาร์ปและรีโหลดปลั๊กอิน (รองรับ voidscape.admin)',
        default: 'op',
      },
    ],
    installation: [
      ...
      'รีสตาร์ทเซิร์ฟเวอร์ โลก the_void_v2 จะถูกโหลดขึ้นอัตโนมัติ พร้อมคัดลอกข้อมูลเดิมจาก /plugins/Voidscape ให้อัตโนมัติ',
    ...
    versions: [
      {
        ...
        fileSize: '124 KB',
        downloadUrl: '/api/download?plugin=evergarden&v=3.0.0',
        filename: 'evergarden.jar',
        changelog: [
          'เปลี่ยนชื่อระบบและแบรนดิ้งเป็น Evergarden 3.0 (Advance Magic Expansion)',
          'รองรับคำสั่ง /evergarden และ /garden พร้อมทั้งรักษาคำสั่งเดิม /void และ /voidscape เพื่อความเข้ากันได้แบบ 100%',
          'สวนลอยฟ้า Twilight Gardens: ท้องฟ้ายามโพล้เพล้ ป่าซากุระและดอกไม้ บ่อน้ำเรืองแสง และพื้นที่สร้างบ้านราบ 21x21 นอกเขตวิหาร',
          ...
          'ย้ายข้อมูลอัตโนมัติจากโฟลเดอร์ /plugins/Voidscape มายัง /plugins/Evergarden โดยคงความคืบหน้าเดิม',
        ],
      },
      {
        version: '2.2.0',
        ...
        fileSize: '101 KB',
        downloadUrl: '/api/download?plugin=evergarden&v=2.2.0',
      ...
      },
      {
        ...
        fileSize: '70 KB',
        downloadUrl: '/api/download?plugin=evergarden&v=1.5.0',
    ...
    versions: [
      {
        ...
        changelog: [
          ...
          'แกนเวทมนตร์ทั้ง 15 ธาตุ (Core of Lightning, Core of Frost, Core of Shadows, Core of Wither, Core of the Void ฯลฯ) ไม่สามารถคราฟต์ได้ใน Overworld ต้องหาดรอปจากหีบ Evergarden Vault ในมิติ Evergarden เท่านั้น',
