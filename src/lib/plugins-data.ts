...
export const PLUGINS: PluginData[] = [
  ...
  },
  {
    ...
    name: 'Evergarden',
    slug: 'evergarden',
    tagline: 'มิติสวนลอยฟ้า Evergarden, 3 มหาวิหารธาตุ, 22 มนตราเทพ และคัมภีร์ Unbreakable',
    description:
    ...
    features: [
      {
        title: 'มิติ Evergarden & ประตู Crying Obsidian',
        description: 'สร้างโครงประตูเนเธอร์จาก Crying Obsidian จุดด้วย Fire Charge หรือ Eye of Ender เพื่อเดินทางสู่ Evergarden',
      },
      {
        title: '3 มหาวิหารธาตุ & บอสสุดโหด',
        description: 'ท้าทายบอสเลือดหนาที่โจมตีด้วย True Damage ทะลวง Protection VIII พร้อมระบบ Anti-Pillar ป้องกันการต่อเสาหนี',
      },
      {
        title: 'หีบสมบัติ Evergarden Vault & ของรางวัลแรร์',
        description: 'ปราบบอสรับกุญแจเปิด Vault ลุ้นรับ Scroll of Eternity (ไม่มีวันพัง 0.5%), Limit Break, 22 Unique Enchants และแกนคทา Advance Magic',
      },
      {
      ...
      {
        title: 'คู่มือ 24 หน้าในเกม & เมนูทดสอบ Admin',
        description: 'เปิดหนังสือคู่มือภาษาไทย 24 หน้า อ่านง่ายสบายตา อธิบายคทาครบ 15 ธาตุ และ 22 มนตราเทพครบทุกชิ้น (/evergarden guide) พร้อมเมนู /evergarden test',
      },
    ],
    commands: [
      {
      ...
      {
        command: '/evergarden test',
        description: 'เปิดหน้าต่าง Admin Test Kit GUI เสกของ/คัมภีร์/บอสในคลิกเดียว (เฉพาะ Admin)',
    ...
    versions: [
      {
        ...
        changelog: [
          ...
          'อัปเดตคู่มือในเกม 24 หน้า อ่านง่ายสบายตา อธิบายไอเทม คทา 15 ธาตุ และ 22 มนตราเทพครบทุกชิ้น ไม่ล้นหน้าจอ',
          'ปรับแต่งฟอนต์และสีข้อความให้อ่านง่าย ชัดเจน ไม่ใช้ตัวหนาสีดำที่ซ้อนกัน และใส่ลูกเล่นกรอบเวทเฉพาะไอเทมระดับตำนาน Mythic',
          ...
          'แก้ไขแท่น Lodestone ให้ผู้เล่นทุกคน (รวม Non-OP และ Creative) กดเริ่มท้าทายได้แน่นอน',
          'แก้ไข Vein Smelter ให้ดรอปแร่ถ่านและอัญมณีถูกต้องพร้อมรับผลของ Fortune และ EXP เต็มระบบ',
        ],
      },
    ],
  },
