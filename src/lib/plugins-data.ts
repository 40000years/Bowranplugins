...
export const PLUGINS: PluginData[] = [
  ...
  },
  {
    ...
    name: 'Evergarden',
    slug: 'evergarden',
    tagline: 'ภาคเสริม Advance Magic: มิติ Evergarden สวนลอยฟ้า, 3 มหาวิหารธาตุ และ Evergarden Vault',
    description:
      'ภาคเสริมอย่างเป็นทางการของ Advance Magic เปิดประตูมิติด้วย Crying Obsidian สำรวจสวนลอยฟ้าและ 3 มหาวิหารธาตุ และปลดล็อก Evergarden Vault',
    longDescription:
      'ปลั๊กอินสำรวจมิติ Evergarden (Twilight Gardens) ได้รับการปรับปรุงใหม่ทั้งหมดเพื่อเป็นภาคเสริมของ Advance Magic ผู้เล่นสามารถสร้างโครงประตู Nether Portal ด้วยบล็อก Crying Obsidian และจุดด้วย Fire Charge หรือ Eye of Ender เพื่อข้ามมิติ ณ เกาะเกิดจะมีแท่น Lectern พร้อมคู่มือภาษาไทยและประตูกลับ มีทางเดินเชื่อมไปยัง 3 มหาวิหารธาตุโบราณ (Sanctum of Darkness, Astral Sanctum, Chrono Sanctum) ปราบเวฟผู้พิทักษ์ 5 เวฟและบอสเพื่อรับ Evergarden Key (พร้อมระบบ Anti-Boat Cheese 100% ห้ามมอนสเตอร์ขึ้นเรือหรือรถราง) นำกุญแจมาเปิดหีบ Evergarden Vault สไตล์ Trial Chamber เพื่อรับไอเทมแกนเวทมนตร์ Advance Magic, บล็อกเพชร, แท่งเนเธอไรต์, ลายเกราะหายาก และอุปกรณ์พิเศษขุด 3x3 หรือเผาแร่อัตโนมัติ',
    accentColor: '#10b981',
    ...
    tags: ['Advance Magic', 'Evergarden', 'Twilight Gardens', 'Dimension', 'Sanctum', 'Trial Vault', 'Crying Obsidian'],
    ...
    features: [
      {
        ...
        description: 'สร้างโครงประตูเนเธอร์จาก Crying Obsidian จุดด้วย Fire Charge หรือ Eye of Ender เพื่อเดินทางสู่ Evergarden',
      },
      {
        title: '3 มหาวิหารธาตุ (Sanctums) & สวนลอยฟ้า',
        description: 'สถาปัตยกรรมเฉพาะตัว 3 แห่ง: Sanctum of Darkness, Astral Sanctum, และ Chrono Sanctum พร้อมทางเดินเชื่อมจากเกาะเกิด',
      },
      {
      ...
      {
        title: 'หีบและกุญแจ Evergarden Vault & Key',
        description: 'ปราบบอสรับ Evergarden Key คนละ 1 ดอกต่อคน เปิดคลังสมบัติสไตล์ 1.21 รับของรางวัลทันที (เปิดได้คนละ 1 ครั้งต่อวิหาร)',
      },
      {
        title: 'เรตของรางวัล Evergarden Vault (30/30/20/10/10)',
    ...
    commands: [
      {
        command: '/evergarden guide',
        description: 'เปิดหนังสือคู่มือนักสำรวจภาษาไทย แนะนำระบบและพิกัดวิหาร (รองรับ /void guide)',
    ...
    permissions: [
      {
        node: 'evergarden.enter',
        description: 'สิทธิ์ใช้งานประตู Crying Obsidian และคำสั่งแนะนำตัวเบื้องต้น',
        default: 'true',
      },
      {
        node: 'evergarden.admin',
        description: 'สิทธิ์ผู้ดูแลระบบสำหรับคำสั่งวาร์ปและรีโหลดปลั๊กอิน',
        default: 'op',
      },
    ],
    installation: [
      'ดาวน์โหลดไฟล์ evergarden.jar จากปุ่มด้านล่าง',
      'นำไฟล์ไปวางในโฟลเดอร์ /plugins/ ของเซิร์ฟเวอร์ Paper 26.2 (แนะนำให้ติดตั้งคู่กับ Advance Magic)',
      'รีสตาร์ทเซิร์ฟเวอร์ โลก evergarden จะถูกสร้างและโหลดขึ้นอัตโนมัติ',
      'ตัวปลั๊กอินฝัง Resource Pack ในไฟล์ .jar และจะแตกไฟล์ลง /plugins/Evergarden/resource-packs/ พร้อมติดตั้งลง Geyser ให้ทันที',
    ],
    configuration:
      'สามารถปรับแต่งค่า wave มอนสเตอร์, บอส HP, จุดเกิด, และรายการของรางวัลได้ที่ /plugins/Evergarden/config.yml',
    versions: [
      {
        version: '3.0.0',
        minecraftVersions: ['26.2'],
        ...
        fileSize: '164 KB',
        downloadUrl: '/api/download?plugin=evergarden',
        filename: 'evergarden.jar',
        changelog: [
          'เปลี่ยนชื่อระบบและแบรนดิ้งเป็น Evergarden 3.0 (Advance Magic Expansion)',
          'ปรับมิติเป็น Evergarden (Twilight Gardens): ท้องฟ้ายามโพล้เพล้ ป่าซากุระและดอกไม้ บ่อน้ำเรืองแสง และพื้นที่สร้างบ้านราบ 21x21 นอกเขตวิหาร',
          '3 มหาวิหารธาตุโปร่งโล่ง: Sanctum of Darkness, Astral Sanctum, Chrono Sanctum พร้อมทางเดินแสงเชื่อมต่อจากเกาะเกิด',
          'ระบบผู้พิทักษ์ 5 เวฟและบอส พร้อมโมเดลสวมศีรษะ 3 มิติ 6 แบบ (Thorn/Astral/Chrono Mask และ Crown)',
          'หีบและกุญแจ Evergarden Vault & Evergarden Key: ปราบบอสรับกุญแจ ปลดล็อกหีบได้คนละ 1 ครั้งต่อวิหาร',
          'เรตรางวัล 100% (35/35/10/15/5): 35% Diamond Block x2, 35% Netherite Ingot x2, 10% Armor Trim Template x2 (18 ลาย), 15% อุปกรณ์พิเศษ (Rift Excavator, Smelter\'s Pickaxe, Storm Bow), 5% สุ่มแกนคทา Core of ... (1 ใน 15 แบบของ Advance Magic รวมถึง 0.1% Mythic Core of Levitation)',
          'ฝัง Resource Pack (Java .zip, Bedrock .mcpack, Geyser Mappings) ในตัว .jar พร้อม Built-in HTTP Server พอร์ต 8188 สำหรับ Java และ Auto-Install เข้า Geyser อัตโนมัติ',
        ],
      },
    ],
  },
    ...
    versions: [
      {
        ...
        changelog: [
          ...
          'คำสั่งย่อ /nv [on|off|toggle] (อนุญาตให้ผู้เล่นทั่วไปใช้งานได้โดยไม่ต้องมีสิทธิ์ OP)',
        ],
      },
    ],
  },
    ...
    versions: [
      {
        ...
        changelog: [
          'เพิ่มระบบสกิลสะท้อนจังหวะสอง (15-Spell Follow-up Echoes) และปรับสมดุลเวทมนตร์ทั้ง 15 บท',
          'ปรับปรุงอนุภาค Dragon Breath และ Flash พร้อมกำหนดค่า Burst Damage ในคอนฟิก',
          'ยกเครื่องระบบสูตรคราฟต์คทาเวทมนตร์: ใช้แกน Core of ... 15 ธาตุ ล้อมรอบด้วย 8 Netherite Ingot / Nether Star',
          'แกนเวทมนตร์ 15 ธาตุหาดรอปได้จาก Evergarden Vault ในมิติ Evergarden',
          'เพิ่ม Resource Pack พิกเซลอาร์ต 128x128 และโมเดล 3D สำหรับแกนเวทมนตร์ทั้ง 15 ชิ้น สำหรับ Java และ Bedrock',
          'คำสั่ง /magic give <player> <spell> [wand|core] และ /magic givecore สำหรับผู้ดูแลระบบ',
        ],
      },
      {
        version: '1.2.0',
